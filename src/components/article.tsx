...
class Article extends React.Component<ArticleProps, ArticleState> {
  ...
  articleView = () => {
    const a = encodeURIComponent(
      this.state.loadFull ? this.state.fullContent : this.props.item.content
    );
    ...
    return `article/article.html?a=${a}&h=${h}&f=${encodeURIComponent(this.state.fontFamily)}&s=${
      this.state.fontSize
    }&d=${this.props.source.textDir}&u=${this.props.item.link}&m=${this.state.loadFull ? 1 : 0}`;
  };
