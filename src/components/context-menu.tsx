              ...
              items: [
                {
                  ...
                  onClick: () =>
                    this.props.markAllRead(null, this.props.item.date),
                },
                {
                  key: "markAbove",
                  ...
                  onClick: () =>
                    this.props.markAllRead(null, this.props.item.date, false),
                },
              ],
            },
          },
                    ...
                    items: [
                      {
                        ...
                        canCheck: true,
                        checked: Boolean(
                          this.props.viewConfigs & ViewConfigs.ShowCover
                        ),
                        onClick: () =>
                      ...
                      },
                      {
                        ...
                        canCheck: true,
                        checked: Boolean(
                          this.props.viewConfigs & ViewConfigs.ShowSnippet
                        ),
                        onClick: () =>
                          this.props.setViewConfigs(
                            this.props.viewConfigs ^ ViewConfigs.ShowSnippet
                      ...
                      },
                      {
                        ...
                        canCheck: true,
                        checked: Boolean(
                          this.props.viewConfigs & ViewConfigs.FadeRead
                        ),
                        onClick: () =>
                          this.props.setViewConfigs(
                            this.props.viewConfigs ^ ViewConfigs.FadeRead
              ...
              items: [
                {
                  ...
                  onClick: e => {
                    window.utils.openExternal(this.props.url, platformCtrl(e))
                  },
                },
                {
                  key: "copyURL",
              ...
              items: [
                {
                  ...
                  canCheck: true,
                  checked:
                    (this.props.filter & ~FilterType.Toggles) ==
                    FilterType.Default,
                ...
                },
                {
                  ...
                  onClick: () =>
                    this.props.switchFilter(FilterType.StarredOnly),
                },
              ],
            },
          },
