    ...
    return (
      <nav className={this.getClassNames()}>
        <div className="btn-group">
          <a className="btn hide-wide" title={intl.get("nav.menu")} onClick={this.props.menu}>
        ...
        <div className="btn-group" style={{ float: "right" }}>
          ...
          <a className="btn" title={intl.get("nav.settings")} onClick={this.props.settings}>
          ...
          <a className="btn system" title={intl.get("nav.maximize")} onClick={this.maximize}>
